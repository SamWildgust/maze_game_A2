...
public class Main extends ApplicationAdapter {
    ...
    public static boolean bookRead = false; // Whether the player has read the book/received the hint.
    ...
    public static void Hint() {
        if (longboiBonus == 0 && !bookRead) {
            ...
            ToastSystem.addToast("Sorry, there isn't anything new to read!");
            }
        }
