...
public class RenderingSystem {
    ...
    public void draw(Player player, Dean dean, boolean showCollision, float elapsedTime, List<Rectangle> worldCollision) {
        ...
        String scoreText = "Current Score = " + Main.calculateScore();
        font.draw(uiBatch, scoreText, Gdx.graphics.getWidth() -150, Gdx.graphics.getHeight()-10); // Constantly updates player score
